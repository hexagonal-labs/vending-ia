  ...
  server.registerTool(
    'list_machine_products',
    {
      ...
      description:
        ...
        'Para existencias use stock.available y stock.status; stock.missing procede exclusivamente de MDB y ' +
        'stock.updatedAt indica la fecha de esa lectura. needsRestock solo es true si existe alertThreshold y ' +
        'stock.available es igual o inferior a ese umbral. ' +
      ...
      inputSchema: {
        ...
        onlyNeedingRestock: z
          .boolean()
          .optional()
          .describe('Si es true, devuelve solo productos cuyo stock MDB está igual o por debajo del umbral configurado'),
      },
      annotations: { readOnlyHint: true },
    },
